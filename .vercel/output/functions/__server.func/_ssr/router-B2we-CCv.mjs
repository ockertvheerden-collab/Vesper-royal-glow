...
//#region node_modules/.nitro/vite/services/ssr/assets/router-B2we-CCv.js
var router_B2we_CCv_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-89VaSoeT.css";
var APP_NAME = "Vesper";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A 3D constellation of characters. Drag to orbit, click a portrait to focus."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-NcvQO8s8.mjs").then((n) => n.t);
...
//#endregion
export { getRouter, router_B2we_CCv_exports as t };
